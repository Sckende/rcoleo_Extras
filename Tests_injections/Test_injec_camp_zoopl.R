...
library(readr)
# WINDOWS
camp_zoopl <- read_delim("C:/Users/HP_9470m/Desktop/rcoleo_Extras/Tests_injections/Test_injection_campagnes/Campagne_zoopl_denombrement.csv", ";")
...
# ICI pb avec la fonction rcoleo::get_sites() avec des sites qui manquent
